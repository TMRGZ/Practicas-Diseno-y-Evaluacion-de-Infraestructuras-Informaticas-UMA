...
__global__ void VecAdd(const float* A, const float* B, float* C, int N)
{
    ...
    // Descomentar la siguiente linea si queremos monitorizar en pantalla la traza de ejecucion por hilos
...
{
    int N = 25600;  // Elegimos un tama�o de problema que ejecute exactamente 100 bloques de 256 hilos
    ...
    printf("%s \n", (i == N) ? "RESULTADOS CORRECTOS Y VALIDADOS CON LA CPU" : "RESULTADOS INCORRECTOS. NO COINCIDEN CON LOS OBTENIDOS POR LA CPU TRAS LA EJECUCION SECUENCIAL DEL CODIGO");
